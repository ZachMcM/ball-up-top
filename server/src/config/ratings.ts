...
export const RUN_COMP_MIN_WT = 0.7
export const RUN_COMP_MAX_WT = 1.2

// weight range for rater overall
export const RATER_MIN_WT = 0.7
export const RATER_MAX_WT = 1.2

export const OVERLAP_MS_THRESH = 2 * 60 * 1000

// ranges for overlap weights
export const MIN_OVERLAP_WT = 0.4
export const MAX_OVERLAP_WT = 1

// if lifetime sessions less than this, no outlier penalties
export const MIN_LIFETIME_CT = 5

// outlier thresholds - how far the rating differs from current
