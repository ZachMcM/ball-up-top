                ...
                <Pressable
                  ...
                  <View className="flex flex-row items-center gap-1">
                    {user.rank && (
                      <Text
                        className={cn(
                          'w-8 font-bebas text-3xl tabular-nums leading-[33px]',
        ...
        {currentUserEntry && (
          <View className="absolute bottom-2 left-3 right-3 flex flex-row items-center gap-3 rounded-2xl bg-primary px-4 py-3">
            ...
            <View className="flex flex-col items-center">
              ...
              />
              <Text className="text-[10px] font-medium tracking-tight text-primary-foreground/90">
                OVR
              </Text>
            </View>
          </View>
