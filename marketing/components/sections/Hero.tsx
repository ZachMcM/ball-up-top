  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-28 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none">
        ...
        <div className="absolute top-0 right-0 w-[900px] h-[900px] rounded-full bg-accent/[0.06] blur-[180px] -translate-y-1/3 translate-x-1/4" />
        {/* Court arc rings */}
        <div className="absolute right-[-280px] top-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full border border-accent/[0.05]" />
        <div className="absolute right-[-140px] top-1/2 -translate-y-1/2 w-[640px] h-[640px] rounded-full border border-accent/[0.04]" />
        <div className="absolute right-[0px] top-1/2 -translate-y-1/2 w-[420px] h-[420px] rounded-full border border-accent/[0.03]" />
        {/* Subtle grid */}
        <div
        ...
        <div className="grid lg:grid-cols-[55%_45%] gap-12 xl:gap-20 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-in-up delay-300">
              <a
                href="#download"
                className="inline-flex items-center justify-center gap-2 h-14 px-8 text-base font-semibold bg-accent text-white rounded-full hover:bg-accent/90 active:scale-[0.98] transition-all shadow-lg shadow-accent/20"
              >
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-border animate-fade-in-up delay-400">
              <div>
                <p className="font-heading text-3xl text-accent leading-none mb-1">40+</p>
                <p className="text-sm text-muted-foreground">Player archetypes</p>
              </div>
              <div className="w-px h-10 bg-border" />
              <div>
                <p className="font-heading text-3xl leading-none mb-1">45–99</p>
                <p className="text-sm text-muted-foreground">Rating scale</p>
              </div>
              <div className="w-px h-10 bg-border" />
              <div>
                <p className="font-heading text-3xl leading-none mb-1">Real</p>
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in-right delay-300">
            <div className="relative mt-12 lg:mt-0">
              ...
              {/* Rank-up notification — top right */}
              <div className="absolute -top-5 -right-4 sm:-right-8 bg-card border border-border rounded-2xl px-4 py-3 flex items-center gap-3 shadow-2xl shadow-black/60 z-10 animate-float-delayed">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-accent font-medium">#3 → #2 at Purdue</p>
                </div>
              </div>
              ...
              <div className="relative bg-card border border-border rounded-2xl p-5 w-[320px] sm:w-[340px] shadow-2xl shadow-black/60">
                ...
                <div className="space-y-1.5">
                  {leaderboard.map((player, i) => (
                    ...
                    >
                      <span
                        className={`font-heading text-[15px] w-6 shrink-0 text-center leading-none ${
                          player.rank === 1
                            ? "text-accent"
                      ...
                      <span
                        className={`font-heading text-[22px] leading-none shrink-0 ${
                ...
                <div className="mt-4 pt-4 border-t border-border flex items-center justify-between">
                  <p className="text-[11px] text-muted-foreground">47 players ranked</p>
              ...
              {/* Floating archetype card — bottom left */}
              <div className="absolute -bottom-10 -left-6 sm:-left-12 bg-card border border-border rounded-2xl p-4 w-44 shadow-2xl shadow-black/60 z-10 animate-float">
                ...
                <p className="font-heading text-[18px] uppercase leading-tight mb-0.5">
                  3 & D Wing
                </p>
                <p className="font-heading text-[28px] text-accent leading-none mb-3">84</p>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-1.5">
                      <span className="text-[9px] text-muted-foreground w-5 shrink-0 tracking-wide">
                        {label}
                      </span>
