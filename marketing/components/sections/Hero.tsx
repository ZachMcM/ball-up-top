        ...
        <div className="grid lg:grid-cols-[55%_45%] gap-12 xl:gap-20 items-center">
          ...
          <div>
            ...
            <div className="mb-8 animate-fade-in-up delay-100">
              <h1 className="text-[76px] sm:text-[96px] lg:text-[108px] xl:text-[128px] uppercase leading-[0.87] tracking-tight">
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-border animate-fade-in-up delay-400">
              <div>
                <p className="text-3xl text-accent leading-none mb-1">40+</p>
              ...
              <div>
                <p className="text-3xl leading-none mb-1">45–99</p>
                <p className="text-sm text-muted-foreground">Rating scale</p>
              </div>
              <div className="w-px h-10 bg-border" />
              <div>
                <p className="text-3xl leading-none mb-1">Real</p>
                <p className="text-sm text-muted-foreground">
                  Peer ratings only
                </p>
              </div>
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in-right delay-300">
            <div className="relative mt-12 lg:mt-0">
              ...
              <div className="relative bg-card border border-border rounded-2xl p-5 w-[320px] sm:w-[340px] shadow-2xl shadow-black/60">
                ...
                <div className="flex items-start justify-between mb-5">
                  <div>
                    ...
                    <p className="text-[22px] uppercase tracking-wide leading-tight">
                      Purdue Basketball
                    </p>
                  </div>
                ...
                <div className="space-y-1.5">
                  {leaderboard.map((player, i) => (
                    ...
                    >
                      <span
                        className={`text-[15px] w-6 shrink-0 text-center leading-none ${
                          player.rank === 1
                            ? "text-accent"
              ...
              <div className="absolute -bottom-10 -left-6 sm:-left-12 bg-card border border-border rounded-2xl p-4 w-44 shadow-2xl shadow-black/60 z-10 animate-float">
                ...
                <p className="text-[18px] uppercase leading-tight mb-0.5">
                  3 & D Wing
                </p>
                <p className="text-[28px] text-accent leading-none mb-3">84</p>
