              ...
              <div key={step.number} className="relative text-center lg:text-left">
                ...
                <div className="relative inline-flex lg:flex items-center justify-center w-[76px] h-[76px] mb-6 mx-auto lg:mx-0">
                  ...
                  <div className="absolute -top-1 -right-1 w-6 h-6 bg-accent rounded-full flex items-center justify-center z-20">
                    <span className="font-heading text-[11px] text-white leading-none">
                      {String(index + 1)}
                    </span>
                  </div>
                </div>
        ...
        <div className="mt-20 bg-card border border-border rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xl">
              More check-ins means more data. More data means more accurate ratings. More accurate ratings
              makes the leaderboard more meaningful. The campus basketball community becomes self-reinforcing —
              everyone has more reason to keep coming back.
            </p>
          </div>
        </div>
      </Container>
