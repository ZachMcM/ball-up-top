        ...
        <div className="relative bg-card border border-border rounded-3xl overflow-hidden">
          ...
          <div className="relative px-8 py-14 md:px-16 md:py-20">
            <div className="max-w-2xl">
              ...
              {/* Headline */}
              <h2 className="text-[56px] sm:text-[72px] md:text-[88px] uppercase leading-[0.88] tracking-tight mb-6">
              ...
              <p className="text-[17px] text-muted-foreground leading-relaxed max-w-lg mb-10">
                The competition has already started. Every session at the rec
                center is someone else building their rating. Get on the board
                before your spot at the top is taken.
              </p>
